void shaping_digitizer_traces(){
  ...
  TFile *f = TFile::Open("./output/gtd_to_tree/ver20191220/run_1344_gtd05_001_0118_traces.root");
  f->ls();
  
  TGraph *gr = f->FindObjectAny("traces");
